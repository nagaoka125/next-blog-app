...
　
    ...
    // idと一致するカテゴリが存在しないときの画面
    if (currentCategory === undefined) {
        return (<div className="text-red-500">指定のidのカテゴリは存在しません。</div>);
    }
            ...
            >
                <div className="space-y-6">
                    <div className="space-y-1">
                        ...
                        <div className="text-gray-500">{currentCategory}</div>
                    </div>
                        ...
                        {categories.map((category) => (
                            <div
                                ...
                                className={twMerge(
                                    ...
                                    currentCategory === category.name && " bg-gray-100"
                                )}
                            >
